      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-1 space-y-8">
            <div>
              <span className="text-[#2B59C3] font-bold text-sm uppercase tracking-widest mb-2 block">Get in Touch</span>
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Let&apos;s Start a Conversation
              </h2>
              <p className="text-gray-600 leading-relaxed">
                Whether you have questions about our programs, want to volunteer, or just want to say hello, we&apos;re here to help.
              </p>
            </div>
