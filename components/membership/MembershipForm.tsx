...
import { Send, User, MapPin, Briefcase, Phone, Calendar, Home, Loader2, CheckCircle } from 'lucide-react';
...
export default function MembershipForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/member-registration`, {
        method: 'POST',
        headers: {
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="bg-white rounded-3xl shadow-xl p-12 text-center border border-gray-100">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              Thank you for registering with Eruwa Youth Movement. Your application has been received successfully.
            </p>
            <button 
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
          <div className="bg-[#0e4b68] p-8 md:p-12 text-white text-center">
            ...
            <p className="text-blue-100 max-w-2xl mx-auto">
              Join the movement. Fill out the form below to become an official member of EYM.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Membership Application</h2>
            <p className="text-blue-100 max-w-2xl mx-auto">
              Please fill out the form below accurately to process your membership request. All fields are required.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-10">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="gender" className="block text-sm font-bold text-gray-700 ml-1">Gender</label>
                  <select 
                    id="gender" 
                ...
                <div className="space-y-2">
                  <label htmlFor="dateOfBirth" className="block text-sm font-bold text-gray-700 ml-1">Date of Birth</label>
                ...
                <div className="space-y-2">
                  <label htmlFor="religion" className="block text-sm font-bold text-gray-700 ml-1">Religion</label>
                  <select 
                    id="religion" 
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="phoneNumber" className="block text-sm font-bold text-gray-700 ml-1">Phone Number</label>
                  <div className="relative">
                    <input 
                      type="tel" 
                      id="phoneNumber" 
                ...
                <div className="space-y-2">
                  <label htmlFor="residentialAddress" className="block text-sm font-bold text-gray-700 ml-1">Residential Address</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-2">
                  <label htmlFor="town" className="block text-sm font-bold text-gray-700 ml-1">Town</label>
                  <input 
                    type="text" 
                    id="town" 
                    value={formData.town}
                ...
                <div className="space-y-2">
                  <label htmlFor="city" className="block text-sm font-bold text-gray-700 ml-1">City</label>
                  <input 
                    type="text" 
                    id="city" 
                    value={formData.city}
                ...
                <div className="space-y-2">
                  <label htmlFor="country" className="block text-sm font-bold text-gray-700 ml-1">Country</label>
                  <input 
                    type="text" 
                    id="country" 
            ...
            <div>
              <div className="flex items-center gap-3 mb-6 border-b border-gray-100 pb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Origin & Occupation</h3>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="compound" className="block text-sm font-bold text-gray-700 ml-1">Compound</label>
                  <input 
                    type="text" 
                    id="compound" 
                ...
                <div className="space-y-2">
                  <label htmlFor="quarter" className="block text-sm font-bold text-gray-700 ml-1">Quarter</label>
                  <input 
                    type="text" 
                    id="quarter" 
                ...
                <div className="space-y-2 md:col-span-2">
                  <label htmlFor="occupation" className="block text-sm font-bold text-gray-700 ml-1">Occupation</label>
                  <div className="relative">
                    <input 
                      type="text" 
                      id="occupation" 
