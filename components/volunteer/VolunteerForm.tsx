...
import { Send, User, Mail, Phone, Briefcase, Clock, Heart, CheckCircle, Loader2 } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="bg-white rounded-3xl shadow-xl p-12 text-center border border-gray-100">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              We appreciate your interest in volunteering with Eruwa Youth Movement. Your details have been received.
            </p>
            <button 
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
          <div className="bg-[#0e4b68] p-8 md:p-12 text-white text-center">
            ...
            <p className="text-blue-100 max-w-2xl mx-auto">
              Fill out the form below to let us know how you&apos;d like to contribute your time and skills.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                <label htmlFor="occupation" className="text-sm font-bold text-gray-700 ml-1">Occupation</label>
                <div className="relative">
            ...
            <div className="space-y-2">
              <label htmlFor="skills" className="text-sm font-bold text-gray-700 ml-1">Skills & Expertise</label>
              <textarea
                id="skills"
                rows={3}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <label htmlFor="interests" className="text-sm font-bold text-gray-700 ml-1">Area of Interest</label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <label htmlFor="availability" className="text-sm font-bold text-gray-700 ml-1">Availability</label>
                <div className="relative">
