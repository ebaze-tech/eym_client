...
import { Copy, CheckCircle, CreditCard, Building, User, Mail, Send, Loader2 } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="bg-white rounded-3xl shadow-xl p-12 text-center border border-gray-100">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              We have received your donation notification. Thank you for your generosity and support for Eruwa&apos;s development.
            </p>
            <button 
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 text-lg">
                You can make a direct transfer to our official bank accounts. Please use the details below:
              </p>
            </div>

            <div className="space-y-6">
              {bankAccounts.map((account, index) => (
                <div key={index} className="bg-[#0e4b68] rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
                  ...
                  <div className="relative z-10 space-y-6">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <p className="text-blue-200 text-sm font-medium">Bank Name</p>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <p className="text-blue-200 text-sm font-medium">Account Name</p>
                        <p className="text-xl font-bold">{account.accountName}</p>
                      </div>
                    </div>

                    <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm border border-white/10">
                      <p className="text-blue-200 text-sm font-medium mb-2">Account Number</p>
                      <div className="flex items-center justify-between gap-4">
                        <p className="text-2xl md:text-3xl font-mono font-bold tracking-wider break-all">{account.accountNumber}</p>
                        <button 
                          onClick={() => handleCopy(account.accountNumber, index)}
                          className="p-2 hover:bg-white/10 rounded-lg transition-colors shrink-0"
                          title="Copy Account Number"
                        >
                          {copiedIndex === index ? <CheckCircle className="w-6 h-6 text-green-400" /> : <Copy className="w-6 h-6 text-white" />}
                        </button>
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
              ...
              <p className="text-gray-600 text-sm">
                After making a transfer, please fill out the form on this page so we can acknowledge your donation and send you a receipt.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-10 h-fit">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Notify Us of Donation</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="amount" className="text-sm font-bold text-gray-700 ml-1">Amount Sent (₦)</label>
                  <div className="relative">
                ...
                <div className="space-y-2">
                  <label htmlFor="reference" className="text-sm font-bold text-gray-700 ml-1">Reference/Date</label>
                  <input
                    type="text"
                    id="reference"
              ...
              <div className="space-y-2">
                <label htmlFor="message" className="text-sm font-bold text-gray-700 ml-1">Message (Optional)</label>
                <textarea
                  id="message"
                  rows={3}
