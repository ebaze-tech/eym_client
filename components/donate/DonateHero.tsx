    ...
    <section className="relative h-[50vh] min-h-100 w-full overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-end pb-20">
        <div className="max-w-3xl animate-fade-in-up">
          <span className="text-blue-400 font-bold text-sm uppercase tracking-widest mb-4 block">Support Us</span>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
            Make a Donation
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl leading-relaxed font-light">
            Your financial support directly funds community projects, scholarships, and development initiatives in Eruwa.
          </p>
        </div>
      </div>
    </section>
